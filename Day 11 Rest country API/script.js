        ...
        btn.forEach((ele)=>{
          ele.addEventListener("click",()=>{
            ...
            async function weather(){
              let res = fetch(`https://api.openweathermap.org/data/2.5/weather?q=${ele.value}&APPID=ae6e6a13a47c0114c86e27f6fb10594b`)
              let ress = await res
              let res11 = ress.json()
              ...
              lon:${res1.coord.lon}<br>lat${res1.coord.lat}</h5>`
